...
public class DefaultTuplesDownloadServiceAsMasterIT {
  ...
  private TupleChunkFragmentStorageService tupleChunkFragmentStorageServiceSpy;
  ...
  private void initialize() {
    ...
    tupleChunkFragmentStorageServiceSpy =
        spy(new TupleChunkFragmentStorageService(tupleChunkFragmentRepository));
  ...
  public void givenPersistingReservationFails_whenGetTuples_thenRollbackReservedMarkers() {
    ...
    //        TupleChunkMetaDataEntity.of(chunkId, tupleType,
    // count).setStatus(ActivationStatus.UNLOCKED);
    ...
    //    assertEquals(
    //        0, consumptionCachingService.getConsumptionForTupleType(0,
  ...
  public void
    ...
    //    ReservationElement actualReservationElement =
    // actualCreatedReservation.getReservations().get(0);
    ...
    //    assertEquals(
    //        count, consumptionCachingService.getConsumptionForTupleType(0,
    // MULTIPLICATION_TRIPLE_GFP));
    ...
    // tupleChunkMetadataRepository.findById(chunkId).get();
